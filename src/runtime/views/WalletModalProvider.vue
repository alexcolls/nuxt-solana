...
<template>
  <div>
    ...
    <teleport :to="container" v-if="modalOpened">
      <div aria-labelledby="swv-modal-title" aria-modal="true" class="swv-modal" :class="dark ? 'swv-dark' : ''"
        role="dialog">
        ...
        <div class="swv-modal-container" ref="modalPanel">
          <slot name="modal" v-bind="scope">
            <div class="swv-modal-wrapper" :class="{ 'swv-modal-wrapper-no-logo': !hasLogo }">
              ...
              <ul class="swv-modal-list">
                <li v-for="wallet in walletsToDisplay" :key="wallet.adapter.name" @click="
                ...
                ">
                  <button class="swv-button">
                    ...
                    <div v-if="wallet.readyState === 'Installed'" class="swv-wallet-status">
                      Detected
                    </div>
                  </button>
                </li>
              </ul>
              <button v-if="hiddenWallets.length > 0" aria-controls="swv-modal-collapse" :aria-expanded="expandedWallets"
